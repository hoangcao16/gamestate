...
import { detailQASelector } from './slice/selectors';
...
const endpoint =
  'https://api.thegraph.com/subgraphs/name/qtvnnn/qa-trans-history';
...
const QuantumOrder = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      dispatch(actions.detailQARequest(id));
    })();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);

  const { data, isLoading } = useSelector(detailQASelector);
